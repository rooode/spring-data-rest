...
public class RepositoryRestHandlerMapping extends BasePathAwareHandlerMapping {
		...
		if (StringUtils.hasText(repositoryLookupPath) && repositories != null) {
			...
			if (repositoryConfiguration != null) {
				...
				if (corsConfiguration != null) {
					return corsConfiguration.combine(repositoryConfiguration);
				}
	...
	static class CorsConfigurationAccessor {
		 ...
		 */
		protected boolean hasConfiguration(Class<?> repositoryInterface) {
			return AnnotatedElementUtils.findMergedAnnotation(repositoryInterface, CrossOrigin.class) != null;
		}
